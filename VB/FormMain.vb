...
Namespace SelfReferenced
    Partial Public Class FormMain
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Dim dv As DataView = New DataView(dataSet11.Tables(0))
        ...
        Private Sub gridView1_MasterRowGetLevelDefaultView(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.MasterRowGetLevelDefaultViewEventArgs)
